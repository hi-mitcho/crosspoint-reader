...
#define UI_10_FONT_ID (-1475166996)
#define UI_12_FONT_ID (-1598110823)
#define SMALL_FONT_ID (159729588)
#define RESPONDER_18_FONT_ID (1305492905)
...
static_assert(RESPONDER_18_FONT_ID != 0, "Font ID collision with sentinel");
